...
def comparaison(video_path_1, video_path_2):
    ...
    results_1  = perform_inference(video_frames_1, 16 , nom_1, file = 'mmpose/configs/body_2d_keypoint/rtmpose/coco/rtmpose-l_8xb256-420e_aic-coco-256x192.py', download_checkpoints = 'rtmpose-l_simcc-aic-coco_pt-aic-coco_420e-256x192-f016ffe0_20230126.pth')
